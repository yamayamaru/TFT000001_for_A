...
#define tft_io_offset_start_8 9u
#define tft_io_offset_start_16 12u
...
static const uint16_t tft_io_program_instructions[] = {
    ...
    0x7100, // 10: out    pins, 32        side 0 [1] 
    0x1809, // 11: jmp    9               side 1     
    0x98a0, // 12: pull   block           side 1     
    0x7118, // 13: out    pins, 24        side 0 [1] 
    0xb942, // 14: nop                    side 1 [1] 
    0x7108, // 15: out    pins, 8         side 0 [1] 
